<footer class="mt-24 bg-gray-900 sm:mt-12">
    <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
        <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
            ...
            <div class="px-5 py-2">
                <a href="#" class="text-base text-gray-400 hover:text-gray-300"> Highlights </a>
            </div>

            <div class="px-5 py-2">
                <a href="#" class="text-base text-gray-400 hover:text-gray-300"> Tech Stack </a>
            </div>
        ...
        <p class="mt-8 text-center text-base text-gray-400">&copy; 2022 B3ssa.com LLC. All rights reserved.</p>
    </div>
</footer>
